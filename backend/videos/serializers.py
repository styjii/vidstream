...
class VideoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'duration_sec', 'duration_display', 'file_size_mb',
            'format', 'resolution', 'scanned_at', 'last_watched',
...
class WatchHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'device', 'device_name',
            'progress_sec', 'completed', 'watched_at',
        ]
...
class UploadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'status', 'status_display', 'device_name', 'uploaded_at',
        ]
